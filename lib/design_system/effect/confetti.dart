...
class ConfettiEffectState extends State<ConfettiEffect> {
  ...
  Widget build(BuildContext context) {
    ...
    //               10, 10), // set the minimum potential size for the confetti (width, height)
    //           maximumSize: const Size(
    //               50, 50), // set the maximum potential size for the confetti (width, height)
    //           numberOfParticles: 1,
    //           gravity: 0.1,
    //         ),
    //       ),
