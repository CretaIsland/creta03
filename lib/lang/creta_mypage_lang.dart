class CretaMyPageLang {
  ...
  static String useDigitalBarricade = '디지털 바리케이드 기능 사용하기';
  static String useBoard = '전자칠판 기능 사용하기';
  ...
  static List<String> themeList = ['라이트 모드', '다크 모드'];
  static List<String> initPageList = ['커뮤니티', '스튜디오'];
  static List<String> cookieList = ['쿠키 허용', '쿠키 거부'];
  ...
  // 크레타 등급
  static List<String> cretaGradeList = ['크레타 루키', '크레타 스타', '크레타 셀럽'];

  // 요금제 등급
  static List<String> ratePlanList = ['개인 무료', '개인 유료', '팀 유료', '엔터프라이즈'];

  // 팀 등급
  static List<String> teamPermissionList = ['소유자', '관리자', '팀원'];
}
