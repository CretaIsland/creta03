...
class CommunityRightChannelInfoPane extends StatefulWidget {
  const CommunityRightChannelInfoPane({
    super.key,
  ...
  @override
  State<CommunityRightChannelInfoPane> createState() => _CommunityRightChannelInfoPaneState();
}

class _CommunityRightChannelInfoPaneState extends State<CommunityRightChannelInfoPane> {
          ...
          return Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                  widget.currentChannelModel!.description,
