...
class CretaTimelineSample7 extends StatefulWidget {
  const CretaTimelineSample7({super.key});

  @override
  State<CretaTimelineSample7> createState() => _HorizontalTimelineState();
}

class _HorizontalTimelineState extends State<CretaTimelineSample7> {
  @override
  void initState() {
    super.initState();
  }
            ...
            const Expanded(
              child: CustomScrollView(
                slivers: <Widget>[
                  ...
                  SliverPadding(padding: EdgeInsets.only(top: 20)),
                  SliverToBoxAdapter(
                    child: _MessageTimeline(message: 'Delivery timeline:'),
                  ),
                  SliverPadding(padding: EdgeInsets.only(top: 20)),
                  _DeliveryTimeline(),
