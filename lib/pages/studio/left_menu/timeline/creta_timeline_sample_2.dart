  ...
  List<FootballData> _generateFirstHalfData() {
    return <FootballData>[
      ...
      const FootballData(
        ...
        action: Action.goal,
        title: 'Gooooaaaal!',
        subtitle: 'Goal! Lionel Messi slams the ball into the open net from close range.',
      ),
      const FootballData(
        time: "30'",
        team: Team.barcelona,
      ...
      const FootballData(
        ...
        title: 'Ouchh',
        subtitle: 'Mesut Özil is writhing in pain and can now receive medical treatment.',
      ),
    ];
  }
  ...
  List<FootballData> _generateSecondHalfData() {
    return <FootballData>[
      const FootballData(
        ...
        title: 'Offside!',
        subtitle: 'The referee whistle as the Luis Suárez was trying to advance for the goal.',
      ),
      const FootballData(
        time: "61'",
        team: Team.barcelona,
...
class _TimelineFootballChild extends StatelessWidget {
  ...
  Widget _buildIconByAction(Action action) {
    final imageAsset = 'assets/timeline_samples/football/${action.toString().split('.').last}.png';
    return Image.asset(
      imageAsset,
      height: 20,
      width: 20,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Expanded(
            child: Image.asset('assets/timeline_samples/football/barcelona.png'),
          ),
          ...
          const SizedBox(width: 16),
          Expanded(
            child: Image.asset('assets/timeline_samples/football/arsenal.png'),
          ),
        ],
      ),
    );
