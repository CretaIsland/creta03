        ...
        builder: (context, producerDataManager, mediaDeviceDataManager, child) {
          if(mediaDeviceDataManager.videoInputs!.isEmpty) {
            return GestureDetector(
              child: Container(
                ...
                child: const Center(child: Icon(Icons.videocam_off_outlined, color: Colors.white, size: 14))
              ),
            );
          }
          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              height: 28,
              decoration: BoxDecoration(
                color: producerDataManager.webcam == null ? CretaColor.stateCritical : CretaColor.stateNormal,
                borderRadius: BorderRadius.circular(20)
              ),
              child: Center(
                child: Icon(
                  producerDataManager.webcam == null ? Icons.videocam_off_outlined : Icons.videocam_outlined, 
                  color: Colors.white, 
                  size: 14
                )
              )
