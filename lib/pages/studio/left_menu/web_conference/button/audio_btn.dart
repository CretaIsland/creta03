        ...
        builder: (context, producerDataManager, mediaDeviceDataManager, child) {
          if(mediaDeviceDataManager.audioInputs!.isEmpty) {
            return GestureDetector(
              child: Container(
                ...
                child: const Center(child: Icon(Icons.mic_off_outlined, color: Colors.white, size: 14))
              ),
            );
          }
          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              height: 28,
              decoration: BoxDecoration(
                color: producerDataManager.mic?.paused == true || producerDataManager.mic == null ? CretaColor.stateCritical : CretaColor.stateNormal,
                borderRadius: BorderRadius.circular(20)
              ),
              child: Center(
                child: Icon(
                  producerDataManager.mic?.paused == true || producerDataManager.mic == null ? Icons.mic_off_outlined : Icons.mic_outlined, 
                  color: Colors.white, 
                  size: 14
                )
              )
