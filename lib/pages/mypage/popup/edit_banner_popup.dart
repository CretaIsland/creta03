            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(image: Image.memory(widget.bannerImgBytes).image, fit: BoxFit.cover)
                )
              ),
              GestureDetector(
                child: Padding(
          ...
          Padding(
            ...
            child: BTN.fill_blue_t_m(
              ...
              onPressed: () {
                ...
                // 업로드
                HycopFactory.storage!.uploadFile(widget.selectedImg.name, widget.selectedImg.mimeType!, cropImgBytes, folderName: "banner/").then((fileModel) {
                  if(fileModel != null) {
