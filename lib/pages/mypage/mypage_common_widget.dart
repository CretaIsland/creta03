...
class MyPageCommonWidget {
  ...
  static Widget profileImgComponent({
    ...
    return Container(
      ...
      child: Stack(
        children: [
          profileImgUrl.isNotEmpty || profileImgBytes != null  ? const SizedBox.shrink() : 
            Center(
              child: Text(userName.substring(0, 1), style: CretaFont.displayLarge.copyWith(fontSize: 64, fontWeight: FontWeight.w600, color: Colors.white)),
            ),
          editBtn
        ],
      )
  ...
  static Widget channelBannerImgComponent({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: bannerImgUrl.isNotEmpty ? DecorationImage(image: NetworkImage(bannerImgUrl), fit: BoxFit.cover) : null 
      ),
      child: Align(
