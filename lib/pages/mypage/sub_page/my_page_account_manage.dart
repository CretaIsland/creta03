          ...
          child: widget.width > 800
              ? Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('계정 관리',
                          style: CretaFont.headlineLarge.copyWith(
                              fontWeight: FontWeight.w600, color: CretaColor.text.shade700)),
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('팀 요금제를 사용해보세요!',
                                style:
                                    CretaFont.bodySmall.copyWith(color: CretaColor.text.shade400)),
                          ],
                        ),
                      ),
                      ...
                      Row(
                        children: [
                          ...
                          const SizedBox(width: 24.0),
                          BTN.fill_red_t_m(
                              text: CretaMyPageLang.removeAccountBTN, width: 81, onPressed: () {}),
                        ],
                      ),
  ...
  Widget bannerImgComponent() {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          image: CretaAccountManager.getChannel!.bannerImgUrl == ''
              ? null
              : DecorationImage(
        ...
        child: Stack(
          children: [
            CretaAccountManager.getChannel!.bannerImgUrl != ''
                ? const SizedBox()
                : Center(
                    child: Text('선택된 배경 이미지가 없습니다.', style: CretaFont.bodySmall),
                  ),
            Container(
                            ...
                            showDialog(
                                ...
                                builder: (context) {
                                  return EditBannerImgPopUp(
                                      bannerImgBytes: fileBytes, selectedImg: _pickedFile!);
                                });
                          }
                        });
                      }
