        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              image: memberProfileImg==null ? null : DecorationImage(image: Image.network(memberProfileImg).image, fit: BoxFit.cover)
            ),
          ),
      ...
      child: SingleChildScrollView(
        ...
        child: widget.width > 400 ? Padding(
          ...
          child: Column(
            ...
            children: [
              Text(CretaMyPageLang.teamManage, style: const TextStyle(fontFamily: 'Pretendard', fontWeight: CretaFont.semiBold, fontSize: 40, color: CretaColor.text)),
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Text('${CretaMyPageLang.inviteablePeopleNumber} 2/4', style: CretaFont.bodySmall)
                      ],
                    ),
                    const SizedBox(height: 32.0),
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        memberBox("https://static.ebs.co.kr/images/ebs/WAS-HOME/portal/upload/img/programinfo/person/per/1242723602807_VcCnrrJwzW.jpg", "포비"),
                        memberBox("https://static.ebs.co.kr/images/ebs/WAS-HOME/portal/upload/img/programinfo/person/per/1242723549377_49L83YjvJL.jpg", "해리"),
                        memberBox("https://static.ebs.co.kr/images/ebs/WAS-HOME/portal/upload/img/programinfo/person/per/1242723588618_dphGgSgOAp.jpg", "패티")
                      ],
                    ),
                    const SizedBox(height: 32.0),
                    BTN.fill_blue_t_m(
