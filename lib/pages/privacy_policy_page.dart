      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            Text("에스큐아이소프트(주)는 개인정보 보호법 제30조에 따라 정보 주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 다음과 같이 개인정보 처리 지침을 수립, 공개합니다.", style: bodyMedium),
            const SizedBox(height: 32),
            clauseComponent(clauseTitle: "제1조 (개인정보의 처리 목적)", cluaseDescriptionList: ["에스큐아이소프트(주)는 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, \n이용 목적이 변경되는 경우에는 개인정보 보호법 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다."]),
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("회원 가입 의사 확인, 회원제 서비스 제공에 따른 본인 식별 · 인증, 회원자격 유지 관리, 제한적 본인확인제 시행에 따른 본인 확인, 서비스 부정 이용 방지, 만 14세 미만 아동의 개인정보 처리 시 법정대리인의 동의 여부 확인, 각종 고지, 통지, 고충 처리 등을 \n목적으로 개인정보를 처리합니다.", style: bodyMedium),
                  const SizedBox(height: 20),
                  Text("재화 또는 서비스 제공", style: titleMedium),
                   const SizedBox(height: 16),
                  Text("물품 배송, 서비스 제공, 계약서 · 청구서 발송, 콘텐츠 제공, 맞춤 서비스 제공, 본인 인증, 나이 인증, 요금 결제 · 정산, 채권추심 등을 목적으로 개인정보를 처리합니다.", style: bodyMedium),
                  const SizedBox(height: 20),
                  Text("고충 처리", style: titleMedium),
                   const SizedBox(height: 16),
                  Text("민원인의 신원 확인 민원 사항 확인, 사실 조사를 위한 연락 · 통지, 처리결과 통보 등의 목적으로 개인정보를 처리합니다.", style: bodyMedium),
                ]
              )
            ),
            clauseComponent(
              clauseTitle: "제2조 (개인정보의 처리 및 보유기간)",
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text("홈페이지 회원 가입 및 관리", style: titleMedium),
                  const SizedBox(height: 16),
                  Text("  ⦁ 사업자/단체 홈페이지 탈퇴 시까지. 다만, 다음의 사유에 해당하는 경우 해당 사유 종료 시까지.", style: bodyMedium),
                  const SizedBox(height: 10),
                  Text("  ⦁ 관계 법령 위반에 따른 수사 · 조사 등이 진행 중인 경우 해당 수사 · 조사 종료 시까지.", style: bodyMedium),
                  const SizedBox(height: 10),
                  Text("  ⦁ 홈페이지 이용에 따른 채권 · 채무 관계 잔존 시 해당 채권 · 채무관계 정산 시까지.", style: bodyMedium),
                  const SizedBox(height: 24),
                  Text("재화 또는 서비스 제공", style: titleMedium),
                  const SizedBox(height: 16),
                  Text("  ⦁ 재화 · 서비스 공급 완료 및 요금 결제 · 정산 완료 시까지. 다만, 다음의 사유에 해당하는 경우 해당 기간 종료 시까지.", style: bodyMedium),
                  const SizedBox(height: 10),
                  Text("  ⦁ 전자상거래 등에서의 소비자 보호에 관한 법률에 따른 표시 · 광고, 계약 내용 및 이행 등 거래에 관한 기록", style: bodyMedium),
                  const SizedBox(height: 20),
                  ...
                  const SizedBox(height: 20),
                  Text("            ⦁ 가입자 전기통신일시, 개시 · 종료 시각, 상대방 가입자 번호, 사용도수, 발신기지국 위치추적자료 : 1년", style: bodyMedium),
                  const SizedBox(height: 10),
            ...
            const SizedBox(height: 20),
            clauseComponent(clauseTitle: "제6조 (처리하는 개인정보 항목)", cluaseDescriptionList: [" 에스큐아이소프트(주)는 다음의 개인정보 항목을 처리하고 있습니다."]),
            Padding(
              padding: const EdgeInsets.only(top: 20, left: 30, bottom: 32),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  ...
                  Text("재화 또는 서비스 제공", style: titleMedium),
                  const SizedBox(height: 16),
                  Text("  ⦁ 필수항목 : 카드 번호, 유효기간, 비밀번호 앞 2자리, 카드 소유자 이름, 생년월일 또는 사업자등록번호, 연락처, 이메일", style: bodyMedium),
                  const SizedBox(height: 10),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  Text("  에스큐아이소프트(주)는 파기 사유가 발생한 개인정보를 선정하고, 에스큐아이소프트(주)의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.", style: bodyMedium),
                  const SizedBox(height: 24),
                  Text("파기방법", style: titleMedium),
                  const SizedBox(height: 16),
                  Text("  에스큐아이소프트(주)는 전자적 파일 형태로 기록·저장된 개인정보는 기록을 재생할 수 없도록 파기하며, 종이 문서에 기록·저장된 개인정보는 분쇄기로 분쇄하거나 소각하여 파기합니다.", style: bodyMedium),
                ]
              )
            ),
            clauseComponent(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 24),
                  Text("개인정보 처리 시스템 등의 접근권한 관리, 접근통제시스템 설치, 고유식별정보 등의 암호화, 보안프로그램 설치", style: titleMedium),
                  const SizedBox(height: 24),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  Text("  이용자가 방문한 각 서비스와 웹사이트들에 대한 방문 및 이용 형태, 인기 검색어, 보안접속 여부 등을 파악하여 이용자에게 최적화된 정보 제공을 위해 사용됩니다.", style: bodyMedium),
                  const SizedBox(height: 24),
                  Text("쿠키의 설치·운영 및 거부", style: titleMedium),
                  const SizedBox(height: 16),
                  Text("  웹 브라우저 상단의 도구>인터넷 옵션>개인정보 메뉴의 옵션 설정을 통해 쿠키 저장을 거부할 수 있습니다.", style: bodyMedium),
                  const SizedBox(height: 24),
            ...
            clauseComponent(
              clauseTitle: "제10조 (개인정보 보호 책임자)", 
              cluaseDescriptionList: [" 에스큐아이소프트(주)는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보보호 책임자를 지정하고 있습니다."]
            ),
            Padding(
              padding: const EdgeInsets.only(top: 20, left: 30, bottom: 32),
              child: Column(
            ...
            clauseComponent(
              clauseTitle: "제11조 (개인정보 열람청구)", 
              cluaseDescriptionList: [" 정보 주체는 개인정보 보호법 제35조에 따른 개인정보의 열람 청구를 아래의 부서에 할 수 있습니다. 회사는 정보주체의 개인정보 열람 청구가 신속하게 처리되도록 노력하겠습니다."]
            ),
            Padding(
              padding: const EdgeInsets.only(top: 20, left: 30, bottom: 32),
              child: Column(
            ...
            clauseComponent(
              clauseTitle: "제12조 (권익침해 구제방법)", 
              cluaseDescriptionList: [" 정보 주체는 아래의 기관에 대해 개인정보 침해에 대한 피해구제, 상담 등을 문의하실 수 있습니다. \n<아래의 기관은 회사와는 별개의 기관으로서, 회사의 자체적인 개인정보 불만처리, 피해구제 결과에 만족하지 못하시거나 더욱 자세한 도움이 필요하시면 문의하여주시기 바랍니다.>"]
            ),
            Padding(
              padding: const EdgeInsets.only(top: 20, left: 30, bottom: 32),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("  ⦁ 개인정보 침해신고센터 (https://privacy.kisa.or.kr/kor/main.jsp / 국번없이 118)", style: titleMedium),
                  const SizedBox(height: 10),
                  Text("  ⦁ 대검찰청 인터넷범죄수사센터 (http://www.spo.go.kr / 02-3480-2000)", style: titleMedium),
                  const SizedBox(height: 10),
                  Text("  ⦁ 경찰청 사이버안전국(http://cyberbureau.police.go.kr / 국번없이 182)", style: titleMedium)
                ]
              )
            ),
            clauseComponent(
                ...
                SizedBox(
                  ...
                  child: Row(
                    ...
                    children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            customButton(
                              width: 115, 
                              height: 20, 
                              child: Text("개인정보 처리방침", style: CretaFont.bodyMedium.copyWith(color: Colors.white)), 
                              backgroundColor: Colors.black,
                              onTap: () {}
                            )
                          ],
                      ...
                      Text("© 2024 SQISOFT All Rights Reserved", style: CretaFont.bodyESmall.copyWith(color: Colors.white.withOpacity(0.2)))
                    ],
                  ),
                )
              ],
